// import { TModule } from "../types.js";

import { TBackTickString, TIdentifierExpression } from '../types.js';
...
export class ASTBuilder {
  buildBackTickString(str: string): TBackTickString {
    return { backTickString: str };
  }

  buildIdentifier(value: string): TIdentifierExpression {
    return {
      identifier: {
        value,
      },
